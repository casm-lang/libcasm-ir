...
std::string Structure::name( void ) const
{
    return m_name;
}
...
u1 Structure::operator==( const Value& rhs ) const
{
    if( this == &rhs )
    {
        return true;
    ...
    const auto& other = static_cast< const Structure& >( rhs );
...
u1 Structure::classof( Value const* obj )
{
