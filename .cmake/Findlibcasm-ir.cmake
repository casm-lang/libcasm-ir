...
find_library( LIBCASM_IR_LIBRARY
  NAMES libcasm-ir.so libcasm-ir.dylib libcasm-ir.dll
  PATHS ${LIBCASM_IR_PKGCONF_LIBRARY_DIRS}
)

find_library( LIBCASM_IR_ARCHIVE
  NAMES libcasm-ir.a
  PATHS ${LIBCASM_IR_PKGCONF_LIBRARY_DIRS}
)

set( LIBCASM_IR_PROCESS_INCLUDES LIBCASM_IR_INCLUDE_DIR )
set( LIBCASM_IR_PROCESS_LIBS     LIBCASM_IR_LIBRARY LIBCASM_IR_ARCHIVE )

libfind_process( LIBCASM_IR )

if( EXISTS "${LIBCASM_IR_LIBRARY}" AND ${LIBCASM_IR_LIBRARY} AND
    EXISTS "${LIBCASM_IR_ARCHIVE}" AND ${LIBCASM_IR_ARCHIVE} )
