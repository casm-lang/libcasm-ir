...
{
    auto v = libstdhl::Memory::make< StringConstant >( s );
    ...
    auto w = libstdhl::Memory::make< StringConstant >( s );
    ASSERT_TRUE( w != nullptr );

    EXPECT_TRUE( v != w );
    EXPECT_TRUE( *w == *w );

    auto a = libstdhl::Memory::get< StringConstant >( s );
    auto b = libstdhl::Memory::get< StringConstant >( s );
