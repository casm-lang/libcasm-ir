...
{
    {
        auto a = libstdhl::Memory::make< IntegerConstant >( 5 );
    ...
    {
        auto a = libstdhl::Memory::get< IntegerConstant >( 5 );
        auto i = InvInstruction( a );
...
{
    {
        auto a = libstdhl::Memory::make< RationalConstant >( "5" );
        auto i = InvInstruction( a );
    ...
    {
        auto a = libstdhl::Memory::get< RationalConstant >( "5" );
        auto i = InvInstruction( a );
