...
{
    auto v = libstdhl::Memory::make< IntegerType >();
    ASSERT_TRUE( v != nullptr );

    EXPECT_STREQ( v->name().c_str(), "i" );
    EXPECT_STREQ( v->description().c_str(), "Integer" );

    auto w = libstdhl::Memory::make< IntegerType >();
    ASSERT_TRUE( w != nullptr );

    EXPECT_TRUE( v != w );
    EXPECT_TRUE( *v == *w );

    auto a = libstdhl::Memory::get< IntegerType >();
    auto b = libstdhl::Memory::get< IntegerType >();
